...
#pragma config(Servo,  srvo_S1_C1_2,    dump,                 tServoStandard)
#pragma config(Servo,  srvo_S1_C1_3,    zzz,                  tServoStandard)
#pragma config(Servo,  srvo_S1_C1_4,    servo4,               tServoStandard)
#pragma config(Servo,  srvo_S1_C1_5,    servo5,               tServoStandard)
#pragma config(Servo,  srvo_S1_C1_6,    backGrab,             tServoStandard)
...
#include "mainControls.c"    //Forward, Back, etc
